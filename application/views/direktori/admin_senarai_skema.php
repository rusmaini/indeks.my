				...
				<td>
					<div class="row">
						...
						<div class="col-sm-2" align="right">
							<?=anchor('direktori/urus_edit/'.$row['id'],'<span class="glyphicon glyphicon-edit"></span> Edit',array('class'=>'btn btn-primary btn-sm'))?> &nbsp; 
							<?=anchor('direktori/urus_delete/'.$row['id'],'<span class="glyphicon glyphicon-trash"></span> Padam',array('class'=>'btn btn-primary btn-sm','onclick'=>'return confirm(\'Data akan dihapuskan dari pangkalan data. Teruskan?\')'))?>
						</div>
					</div>
				</td>
			</tr>
